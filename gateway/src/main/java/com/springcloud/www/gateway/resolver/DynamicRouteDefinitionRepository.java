package com.springcloud.www.gateway.resolver;
...
public class DynamicRouteDefinitionRepository implements RouteDefinitionRepository {
    ...
    private final static String GATEWAY_ROUTE_KEY = "gateway_key";
    ...
    public Mono<Void> delete(Mono<String> routeId) {
        return routeId.flatMap(id -> {
            ...
            return Mono.defer(() -> Mono.error(new Exception("not found" + routeId)));
        });
    }
